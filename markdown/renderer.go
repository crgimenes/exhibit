...
func (r *renderer) RenderNode(w io.Writer, node ast.Node, entering bool) ast.WalkStatus {
	...
	case *ast.Emph:
		if entering {
			r.inlineAccumulator.WriteString("\x1b[38;5;15m" + italicOn)
		} else {
			r.inlineAccumulator.WriteString(italicOff + resetAll)
		}

	case *ast.Strong:
		if entering {
			r.inlineAccumulator.WriteString("\x1b[38;5;15m" + boldOn)
		} else {
	...
	case *ast.Code:
		r.inlineAccumulator.WriteString("\x1b[38;5;10m" + string(node.Literal) + resetAll)
